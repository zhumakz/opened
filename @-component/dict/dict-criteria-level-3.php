<?php
    ...
    //  COM: основные параметры
        $com_s = []; // приватные
        $com_c = []; // публичные
        $com_c['name'] = 'dict-criteria-level-3';
        $com_c['icon'] = 'fa-award';
    ...
    //  COM: локализации
        $com_c['lang'] = [
            ...
            'com'   => $GLOBALS['@']['LANG']['DATA']['c-criteria-level-3']
        ];
    //  COM: описание полей представления
        $com_c['head'] = [
            ...
            'id_level_2' => [
                'name' => $GLOBALS['@']['LANG']['DATA']['c-criteria-level-3']['002'],
                'null' => $GLOBALS['@']['LANG']['DATA']['c-criteria-level-3']['100'],
                'view' => 'w-50',
                'edit' => 'c-select-2',
                'data' => 'id_level_2',
                'dict' => true,
    ...
    //  COM: источники данных
        $com_s['base'] = "`dict_criteria_level_3`";
        $com_s['dict'] = [
            'id_level_2' => [
                'field' => 'name_',
    ...
    //  COM: проверка обязательных данным
        $com_c['struct_valid'] = '(v[\"name_en\"] || v[\"name_kz\"] || v[\"name_ru\"]) && v[\"id_level_2\"]';
        $com_s['struct_valid_php'] = '($param["DATA"]["name_en"] || $param["DATA"]["name_kz"] || $param["DATA"]["name_ru"]) && $param["DATA"]["id_level_2"]';
    ...
    //  COM: параметры поиска - поля
        $com_c['search_fields'] = [
            ...
            'id_level_2' => $GLOBALS['@']['LANG']['DATA']['c-criteria-level-3']['002']
        ];
