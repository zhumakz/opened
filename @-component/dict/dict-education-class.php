<?php
    ...
    //  COM: основные параметры
        $com_s = []; // приватные
        $com_c = []; // публичные
        $com_c['name'] = 'dict-education-class';
    ...
    //  COM: локализации
        $com_c['lang'] = [
            ...
            'com'   => $GLOBALS['@']['LANG']['DATA']['c-education-class']
        ];
    //  COM: описание полей представления
        $com_c['head'] = [
            ...
            'id_level' => [
                'name' => $GLOBALS['@']['LANG']['DATA']['c-education-class']['002'],
                'null' => $GLOBALS['@']['LANG']['DATA']['c-education-class']['002'],
                'view' => 'w-50',
    ...
    //  COM: источники данных
        $com_s['base'] = "`dict_education_class`";
        $com_s['dict'] = [
            'id_level' => [
                'field' => 'name_',
                'table_data' => "`dict_education_level`",
                'table_link' => "`dict_link_class_level`",
                'link' => [
                    'Ta' => "`id`",
                    'La' => "`id_class`",
                    'Lb' => "`id_level`",
