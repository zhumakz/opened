<?php
    ...
    //  COM: основные параметры
        $com_s = []; // приватные
        $com_c = []; // публичные
        $com_c['name'] = 'dict-discipline-section';
    ...
    //  COM: локализации
        $com_c['lang'] = [
            ...
            'com'   => $GLOBALS['@']['LANG']['DATA']['c-discipline-section'],
        ];
    //  COM: описание полей представления
        $com_c['head'] = [
            ...
            'id_item' => [
                ...
                'type' => '@-filter',
                'edit' => 'c-select-2',
                'prep' => $GLOBALS['@']['LANG']['DATA']['c-discipline-section']['002'],
                'info' => $GLOBALS['@']['LANG']['DATA']['c-discipline-section']['003'],
                'data' => 'id_item',
                'dict' => true,
                'need' => true,
                'uniq' => true
    ...
    //  COM: источники данных
        $com_s['base'] = "`dict_discipline_section`";
        $com_s['dict'] = [
            'id_item' => [
                'field' => 'name_',
    ...
    //  COM: проверка обязательных данным
        $com_c['struct_valid'] = '(v[\"name_en\"] || v[\"name_kz\"] || v[\"name_ru\"]) && v[\"id_item\"]';
        $com_s['struct_valid_php'] = '($param["DATA"]["name_en"] || $param["DATA"]["name_kz"] || $param["DATA"]["name_ru"]) && $param["DATA"]["id_item"]';
