                                ...
                                <div class="pl-lg-5">
                                    <div class="text-center mb-3">
                                        <h1 class="h4 text-gray-900 mb-4">
                                            <?= $GLOBALS['@']['LANG']['DATA']['p-forgot']['001'] ?>
                                        </h1>
                                        <p>
                                            <?= $GLOBALS['@']['LANG']['DATA']['p-forgot']['002'] ?>
                                        </p>
                                    </div>
                                    <?php if ($com_c['error'] != ''): ?>
                                    ...
                                    <form class="user was-validated mt-4" method="post">
                                        <div class="form-group">
                                            <input
                                                ...
                                                required
                                                maxlength="256"
                                                placeholder="<?= $GLOBALS['@']['LANG']['DATA']['p-forgot']['003'] ?>"
                                                value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>"
                                            />
                                        </div>
                                        <button type="submit" class="btn btn-primary w-100">
                                            <?= $GLOBALS['@']['LANG']['DATA']['p-forgot']['004'] ?>
                                        </button>
                                    </form>
                                    <hr />
                                    <div class="d-flex align-items-center justify-content-between">
                                        <a class="small mr-3 text-center" href="/login">
                                            <?= $GLOBALS['@']['LANG']['DATA']['p-forgot']['005'] ?>
                                        </a>
